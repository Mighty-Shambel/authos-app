<template>
    <div class="" style="background-image:linear-gradient(#199CC5,#c6eaf5);">
          <span >
     <P class="flex justify-center  mt-10 mb-36 text-white ">Welcome to Autos</P>
     <img src="/src/assets/logo.jpg" class="h-16 w-16 rounded-full mx-auto w-auto">
     <p class="flex justify-center text-white text-2xl mb-4">Autos</p>
